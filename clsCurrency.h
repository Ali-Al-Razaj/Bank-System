...
public:
    ...
    static float CurrencyExchange(clsCurrency Currency1, clsCurrency Currency2, float Amount)
    {
        float Currency1_ToDollar = Amount / Currency1.Rate();

        return Currency1_ToDollar * Currency2.Rate();
    }
